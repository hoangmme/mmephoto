...
def process_svg(filename, out_name, skip_index=-1):
    ...
    for idx, s in enumerate(sorted_slots):
        ...
        draw.text((cx - tw/2, cy - th/2), str(display_idx), fill="white", font=font)
...
process_svg('a4-1-new.svg', 'a4-1-preview.png', skip_index=11)
